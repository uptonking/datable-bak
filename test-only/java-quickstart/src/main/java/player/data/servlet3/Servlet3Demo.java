...
@WebServlet(name = "Servlet3Demo", value = "/anno/servlet3")
//@WebServletx(name = "Servlet3Demo", value = "/servlet3")
public class Servlet3Demo extends HttpServlet {

    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        response.getWriter().write("Hello,it's servlet3.0 using @WebServlet");
    }
...
　　或@WebServlet(name="AnnotationServlet",value={"/Servlet3Demo","/Servlet3Demo2"})
 *
 */
