...
public class StandardDaoManager implements DaoManager {
  ...
  private Map idContextMap = new HashMap();//当前StandardDaoManager容器中所有的DaoContext对象，按照DaoContext的id来放置
  private Map typeContextMap = new HashMap();//当前StandardDaoManager容器中所有的DaoImpl接口和对应的DaoContext对象
  private Map daoImplMap = new HashMap();//当前StandardDaoManager容器中所有的DaoImpl对象
