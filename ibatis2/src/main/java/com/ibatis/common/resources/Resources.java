...
public class Resources extends Object {
   ...
   */
  //实现在字节和 Unicode 字符之间转换的 charset、解码器和编码器。
   ...
   * @throws IllegalAccessException If the class is not public, or other access problems arise
   */
  //通过一个类，从ClassInfo对象中获得当前类的一个实例化对象，采用的单例模式，即一旦该类已经实例化，即不用重新再进行实例化对象操作
  ...
  //如果没有缺省的ClassLoader，获得当前线程的ClassLoader
