...
//SqlMapSessionImpl是一个中间转化类，处理一个线程安全的会话，
//其业务执行方法都转化到SqlMapExecutorDelegate对应的方法中去
public class SqlMapSessionImpl implements SqlMapSession {

  protected SqlMapExecutorDelegate delegate; // 核心操作对象
  protected SessionScope sessionScope;//当前session的环境变量
  protected boolean closed;  //判断当前会话是否关闭
