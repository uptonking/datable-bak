...
public class ClassInfo {
    ...
    //对传入的参数类进行处理，获取其没有参数的构造方法作为缺省的构造方法
    ...
    //对传入的参数类进行处理，获取其所有前缀是get或is的方法，包括Public方法和Private方法，
    // 获取get或is的方法不但包括是当前类的方法，也包括祖先类和接口的方法
    // 把这些方法放到getMethods 的HashMap变量中，
    // 把这些方法的返回值放到getTypes的HashMap变量中，
    ...
    //对传入的参数类进行处理，获取其所有前缀是set的方法，包括Public方法和Private方法，
    // 获取set的方法不但包括是当前类的方法，也包括祖先类和接口的方法
    // 把这些方法放到setMethods 的HashMap变量中，
    // 把这些方法的返回值放到setTypes的HashMap变量中，
    ...
    //对传入的参数类进行处理，主要是针对类中属性既没有get、is也没有set方法的属性
