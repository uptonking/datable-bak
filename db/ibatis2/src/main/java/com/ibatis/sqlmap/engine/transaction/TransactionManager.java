...
public class TransactionManager {
  ...
  private TransactionConfig config; //用于生成事务属性的配置对象
  ...
  //根据SessionScope的事务状态来启动事务，当没有适合的事务状态将抛出异常
  ...
  //根据SessionScope的事务状态来提交事务，当没有适合的事务状态将抛出异常
  ...
  //根据SessionScope的事务状态来结束事务，当没有适合的事务状态将抛出异常
