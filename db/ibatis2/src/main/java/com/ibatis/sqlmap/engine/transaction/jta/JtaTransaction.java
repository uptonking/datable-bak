...
public class JtaTransaction implements Transaction {
  ...
  private UserTransaction userTransaction;  // JTA的UserTransaction对象
  private DataSource dataSource;   // JTA的DataSource对象
  ...
  //启动JTA事务，当实例化时并不启动，只有开始实际应用到具体操作的时候才初始化，属于是懒加载模式
