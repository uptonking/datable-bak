...
public class ParameterMapping {
  ...
  private TypeHandler typeHandler; // 类型转化的对象
  private String typeName; // this is used for REF types or user-defined types
  private int jdbcType;  //该参数对应的jdbcType数值
  private String jdbcTypeName;  //该参数对应的jdbcType名称
  private String nullValue;
  private String mode;
  private boolean inputAllowed; //是否允许输入
  private boolean outputAllowed; // 是否允许输出
  private Class javaType;  // 对应的javaType类型
