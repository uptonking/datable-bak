...
public class ResultMapping {
  ...
  private String propertyName; //属性的名称，唯一标识
  private String columnName; //对应数据库表的列名
  private int columnIndex; //对应数据库表的索引号
  private TypeHandler typeHandler; //类型转化对象
  private int jdbcType;  //对应jdbcType的类型
  private String jdbcTypeName; //对应jdbcType的名称
  private String nullValue; 
  private String notNullColumn;
  private String statementName; //对应的statementName的名称
  private Class javaType; //对应java的数据类型
