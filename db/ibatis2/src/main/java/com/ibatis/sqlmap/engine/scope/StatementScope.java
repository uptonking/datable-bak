...
public class StatementScope {
  // Used by Any
  private SessionScope sessionScope;  //当前StatementScope对应的SessionScope
  private ErrorContext errorContext;
  private MappedStatement statement;  //当前StatementScope对应的MappedStatement
  private ParameterMap parameterMap;  //当前StatementScope对应的ParameterMap
  private ResultMap resultMap;   //当前StatementScope对应的ResultMap
  private Sql sql;   //当前StatementScope对应的Sql
  // Used by DynamicSql
  
  //下面的变量用于动态SQL的使用
  private ParameterMap dynamicParameterMap;  //当前StatementScope对应的动态ParameterMap
  private String dynamicSql;  //当前StatementScope对应的动态SQL
  // Used by N+1 Select solution
  private ResultSet resultSet;  //当前StatementScope对应的动态ResultSet,处理查询中的N+1问题
  private Map uniqueKeys;   //处理查询中的处理N+1问题
  private boolean rowDataFound;  //处理查询中的处理N+1问题，用于判断是否查询到数据
  private String currentNestedKey; //处理查询中的处理N+1问题
