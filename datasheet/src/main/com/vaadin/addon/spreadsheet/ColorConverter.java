...
public interface ColorConverter extends Serializable {
     ...
     * @param sb        to write the styles in
     */
     ...
     *
     * @param borderSide Which side the border should go
     * @param attribute  What type of border style we want (solid, dashed..)
     * @param cellStyle  Style for the cell
     ...
     * @param borderSide Which side the border should go
     * @param attribute  What type of border style we want (solid, dashed..)
     * @param format     the active formatting
     * @return CSS color string
     */
    String getBorderColorCSS(BorderSide borderSide, String attribute,
     ...
     *
     * @param attr          border CSS attribute
     * @param colorInstance POI color
     * @return CSS color string
     */
     ...
     *
     * @param styleProvider conditional format rule, table style, etc.
     * @return valid color string with semicolon or <code>null</code> if no
     * color matches.
     */
